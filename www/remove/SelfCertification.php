...
<form name="saForm">
    ...
    <input type="hidden" name="successUrl" value="https://<?=$_SERVER['SERVER_NAME']?>/remove/pwd_checksuccess.php">
    <input type="hidden" name="failUrl" value="https://<?=$_SERVER['SERVER_NAME']?>/remove/pwd_checksuccess.php">
    <!-- successUrl/failUrl 은 분리하여도 됩니다. !-->

</form>
<form id="loginFrm" name="loginFrm" method="post" action="RemoveCheck.php">
    <input type="hidden" name="url" id="url" value="RemoveCheck.php"/>
</form>
        ...
        <section class="sec sec-01">
            <div class="inner">
                ...
                <div class="sub-content">
                    <h3>본인인증</h3>
                    <p class="sub-txt">
                        <span class="fc-red">회원탈퇴</span>을 위한 본인인증이 필요합니다.<br>
