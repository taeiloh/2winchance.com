...
<form name="saForm">
    ...
    <input type="hidden" name="successUrl" value="http://<?=$_SERVER['SERVER_NAME']?>/remove/pwd_checksuccess.php">
    <input type="hidden" name="failUrl" value="http://<?=$_SERVER['SERVER_NAME']?>/remove/pwd_checksuccess.php">
